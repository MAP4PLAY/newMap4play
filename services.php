...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('api_quadras.php')
        .then(response => response.json())
        .then(data => {
            const carousel = document.querySelector('.owl-carousel .owl-theme');
            carousel.innerHTML = ''; // Limpa o conteúdo estático
            ...
            // Reinicializa o carrossel (se necessário, dependendo da sua biblioteca)
        ...
        .catch(error => console.error('Erro ao carregar as quadras:', error));
});
   </script>
   </body>
</html>
